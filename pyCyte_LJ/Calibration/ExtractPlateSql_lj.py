...
folder = '\\\\fserver\\people\\Lisa_Jungherr\\Useful_stuff\\ExtractPlateSQL'
extractPlateSQL('96PPRE_AQ_BP_off_1000',  Server = 'LJUNGHERR-DT\LABCYTE', 
                SourceDatabase = 'M1240_96DEV', SQLTemplateFolder=folder)

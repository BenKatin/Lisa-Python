...
#        print (len(tmdat))
        ...
        BPdat = tmdat[tmdat.PlateTypeName == ('6RESP_AQ_BP2') ]     ; values[0] = BPdat.iat[5,2]
        GPSAdat = tmdat[tmdat.PlateTypeName == ('6RESP_AQ_GPSA2') ] ; values[1] = GPSAdat.iat[5,2]
        GPSBdat = tmdat[tmdat.PlateTypeName == ('6RESP_AQ_GPSB2') ] ; values[2] = GPSBdat.iat[5,2]
#        print (len(BPdat) , len(GPSAdat) , len(GPSBdat) )

        thisDat = pandas.concat([BPdat, GPSAdat, GPSBdat])

#        print (tmdat)        
        return thisDat, values     
